...
public class hod_add_student_2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if(i>0)
			{
				out.println("<script type=text/javascript>alert('Student Data has been entered Successfully!!');location='hod_add_student.jsp';</script>");
			}

			else
			{
				out.println("<script type=text/javascript>alert('course is not available for student. Student details not Entered');location='hod_add_student.jsp';</script>");
			}
		}
		catch(Exception obj)
		{
