...
<title>Viewing Students Details</title>
...
<body>
	...
	<table align="center" border="1" style="border-collapse: collapse">
		...
		<%
			ResultSet rs = st.executeQuery("select sem_id from semester where semester='" + semester
					+ "' and department='" + department + "' and shift ='" + shift + "' and section='" + section + "'");
			int i = 0;
			int j = 0;
			String sem_id = "";
		...
		<%
			...
			if (i == 0 || j == 0) {
				out.print(
						"<script type=text/javascript>alert('Record Not Found!');location='hod_view_student.jsp';</script>");
			}
		%>
	</table>
	<a href="hod_view_student.jsp">Back</a>
