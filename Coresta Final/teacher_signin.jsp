...
<link href="teacher_signin.css" rel="stylesheet">
...
<div id="greeting" style="font-family:Bookman Old Style;font-size:14px;color:#8A2BE2;font-weight:bold;font-style:italic;text-align:left;text-decoration:none;"></div> 
<script>
...
<div id="wb_FontAwesomeIcon2" style="display:inline-block;width:53px;height:57px;text-align:center;z-index:4;">
<div id="FontAwesomeIcon2"><i class="fa fa-users">&nbsp;</i></div>
</div>
<div id="wb_Text2">
<span style="color:#808080;font-family:Arial;font-size:13px;"><br></span><span style="color:#8A2BE2;font-family:Arial;font-size:19px;"><strong>Teacher<br>Sign in</strong></span>
</div>
</div>
<div class="col-3">
</div>
...
<div style="color:#8A2BE2;font-size:14px;font-family:Arial;font-weight:bold;font-style:normal;text-align:left;text-decoration:none" id="basicclock"></div>
<script>
function clock() 
{
...
<div style="color:#8A2BE2;font-size:14px;font-family:Arial;font-weight:bold;font-style:normal;text-align:left;text-decoration:none" id="basicdate"></div>
<script>
   var now = new Date();
...
<form action="ts_home.jsp" name="loginform" method="post" id="LayoutGrid2" onSubmit="return validate(this);">
...
<input type="text" id="username" style="display:block;width:100%;height:28px;line-height:28px;z-index:13;" name="username" placeholder="username">
...
<input type="password" id="password" style="display:block;width:100%;height:28px;line-height:28px;z-index:17;" name="password" placeholder="password">
...
<label for="" id="Label1" onclick="window.location.href='./forget_password.jsp';return false;" style="display:block;width:100%;height:26px;line-height:26px;z-index:23;">Forgot password?</label>
</div>
<div class="col-4">
</div>
<div class="col-5">
