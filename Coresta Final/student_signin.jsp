...
<link href="student_signin.css" rel="stylesheet">
...
<div id="greeting" style="font-family:Bookman Old Style;font-size:14px;color:#B00016;font-weight:bold;font-style:italic;text-align:left;text-decoration:none;"></div> 
<script>
...
<div id="wb_FontAwesomeIcon3" style="display:inline-block;width:49px;height:63px;text-align:center;z-index:4;">
<div id="FontAwesomeIcon3"><i class="fa fa-child">&nbsp;</i></div>
</div>
<div id="wb_Text2">
<span style="color:#B00016;font-family:Arial;font-size:13px;"><br></span><span style="color:#B00016;font-family:Arial;font-size:19px;"><strong>Student<br>Sign in</strong></span>
</div>
</div>
<div class="col-3">
</div>
...
<div style="color:#B00016;font-size:14px;font-family:Arial;font-weight:bold;font-style:normal;text-align:left;text-decoration:none" id="basicclock"></div>
<script>
function clock() 
{
...
<div style="color:#B00016;font-size:14px;font-family:Arial;font-weight:bold;font-style:normal;text-align:left;text-decoration:none" id="basicdate"></div>
<script>
   var now = new Date();
...
<form name="loginform" method="post" action="<?php echo basename(__FILE__); ?>" enctype="application/x-www-form-urlencoded" id="LayoutGrid2" onsubmit="return Validateloginform(this)">
...
<div class="col-3">
<label for="" id="Label4" style="display:block;width:100%;height:36px;line-height:36px;z-index:10;">Log In</label>
...
<input type="text" id="username" style="display:block;width:100%;height:28px;line-height:28px;z-index:13;" name="username" value="" placeholder="username">
...
<input type="password" id="password" style="display:block;width:100%;height:28px;line-height:28px;z-index:17;" name="password" value="" placeholder="password">
...
<label for="rememberme" id="Label7" style="display:block;width:100%;height:26px;line-height:26px;z-index:20;">Remember me</label>
...
<label for="" id="Label1" onclick="window.location.href='';return false;" style="display:block;width:100%;height:26px;line-height:26px;z-index:23;">Forgot password?</label>
</div>
<div class="col-4">
</div>
<div class="col-5">
...
<div class="col-1">
<div id="wb_Text4">
<span style="color:#2F4F4F;font-family:Arial;font-size:21px;"><strong>Student Login is not working right now.<br>Very soon students will be able to enjoy the access to all the features of the website.<br>Thanks for your patience.<br></strong></span><span style="color:#2F4F4F;font-family:Arial;font-size:13px;"><strong><br></strong></span>
</div>
</div>
</div>
</div>
...
<div id="wb_contact" style="display:inline-block;width:100%;z-index:26;">
<a id="contact" style="visibility:hidden">&nbsp;</a>

</div>
</div>
<div class="col-2">
<div id="wb_Image1" style="display:inline-block;width:100%;height:auto;z-index:27;">
...
<div class="col-3">
<input type="text" id="Editbox1" style="display:block;width:100%;height:30px;line-height:30px;z-index:28;" name="Editbox1" value="" placeholder="Email">
<textarea name="TextArea1" id="TextArea1" style="display:block;width:100%;height:88px;z-index:29;" rows="4" cols="44"></textarea>
<input type="submit" id="Button1" name="" value="CONTACT US" style="display:inline-block;width:136px;height:34px;z-index:30;">
</div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-1">
<hr id="Line6" style="display:block;width:100%;height:1px;z-index:31;">
<div id="wb_Text7">
