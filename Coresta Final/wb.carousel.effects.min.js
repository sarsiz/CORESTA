...
b(c).parent().css("width","100%");b(c).parent().css("left","0");var d=b(c).data("state");b(c).find(".frame").each(function(c){b(this).css({width:a+"px"});var f=(a-d.original_width)/2;3==d.scalemode?(d.original_width=b(this).find(".innerframe").outerWidth(),f=(a-d.original_width)/2,b(this).find(".innerframe").css({"margin-left":f+"px"})):b(this).children().each(function(){var a=0,a=b(this).data("left");void 0!=a?a=parseInt(a):(a=parseInt(b(this).css("left")),b(this).data("left",a+"px"));b(this).css("left",
a+f+"px")})})}})(jQuery);